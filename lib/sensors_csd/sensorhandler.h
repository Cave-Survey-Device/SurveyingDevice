...
public:
     ...
     * 
     * @return Vector3f Heading [deg], Inclination [deg], 0
     */
    Vector3f updateInertial();
    ...
    void save_inertial_align_data();
    void load_inertial_align_data();
    void save_tmp_inertial_align_data();
    void load_tmp_inertial_align_data();
    
    void save_tmp_laser_align_data();
    void load_tmp_laser_align_data();
    void save_laser_align_data();
    void load_laser_align_data();
